...
public class MultiThreadChatServerSync {
  ...
  MultiThreadChatServerSync (String name,int i)
  {
    if(i==1)
    {
      System.out.println(name+" "+"Is Connetced!");
    }
    else
    {
      System.out.println(name+" "+"Is DisConnetced!");
    }
  }
  ...
  private static PrintStream data=null;
  ...
  public void run() {
    ...
    try {
      ...
      while (true) {
        ...
        output.println("Enter your name.");
        name = data.readLine().trim();
        MultiThreadChatServerSync abu=new MultiThreadChatServerSync  (name,1);
        if (name.indexOf('@') == -1) {
          break;
        } else {
      ...
      MultiThreadChatServerSync koko=new MultiThreadChatServerSync  (name,2);
      synchronized (this) {
        for (int i = 0; i < maxClientsCount; i++) {
          if (threads[i] == this) {
            threads[i] = null;
